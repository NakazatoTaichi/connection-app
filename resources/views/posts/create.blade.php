                    ...
                    <form action="{{ route('post.store', ['user_id' => $user->id ]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-12" style="font-size: 1.5rem; width: 500px;">
                                ...
                                <input type="text" class="form-control border border-2" style="font-size: 1.5rem;" name="title" id="title">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-6 p-3" style="font-size: 1.5rem;">
                                ...
                                <textarea type="text" rows="8" class="form-control border border-2" name="content" id="content" style="font-size: 1.5rem;"></textarea>
                            </div>
                        </div>
